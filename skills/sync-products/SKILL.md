---
name: sync-products
description: Sync go4.fashion products to the brand's invoicing system dictionary. Each variant (color+size) becomes a separate invoicing product. Required before creating billing orders.
disable-model-invocation: true
argument-hint: [product name or collection name]
---

# Sync Products to Invoicing System
...
From `$ARGUMENTS`, determine what to sync:
