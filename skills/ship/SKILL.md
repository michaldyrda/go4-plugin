---
name: ship
description: Shipping tools — get UPS rate quotes for a shipment or track an existing package by tracking number.
disable-model-invocation: true
argument-hint: [tracking number, or destination country + weight]
---

# Shipping

Rate a shipment or track a package.

## Detect intent from `$ARGUMENTS`

- If it looks like a tracking number (starts with `1Z`): go to **Track**.
