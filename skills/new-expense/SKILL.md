---
name: new-expense
description: Register a cost invoice (expense) — material purchases, shipping, production services, or other costs. Supports document upload (PDF/photo) or manual entry.
disable-model-invocation: true
argument-hint: [file path to invoice]
---

# New Expense

Register a cost invoice in the brand's invoicing system.
...
### Path A: From document (file provided in `$ARGUMENTS`)
