...
Call `get_material_demand` with filters from the manager's request:
- `collection` — optional
- `supplier` — optional
- `material` — optional
...
Ask: **"Przejrzyj ilości. Coś zmienić? Dla pozycji poniżej MOQ — zamówić MOQ czy przeanalizować nadwyżkę?"**
...
Ask: **"Dla których produktów wyprodukować dodatkowe sztuki? Potwierdź ilości."**
